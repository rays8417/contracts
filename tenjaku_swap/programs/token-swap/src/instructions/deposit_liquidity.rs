...
pub fn deposit_liquidity(
    ...
    // Check for overflow before multiplication to prevent panic
    // For 100K tokens with 9 decimals: 100K × 1e9 = 100 trillion base units
    let max_safe_amount = 100_000_000_000_000u64; // 100 trillion
    if amount_a > max_safe_amount || amount_b > max_safe_amount {
